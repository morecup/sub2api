<template>
  ...
  >
    ...
    >
      ...
      <div v-if="form.platform === 'openai' && accountCategory === 'oauth-based'" class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
...
const buildOpenAIExtra = (base?: Record<string, unknown>): Record<string, unknown> | undefined => {
  ...
  if (accountCategory.value === 'oauth-based' && codexToolFrameOn5hExhaustedEnabled.value) {
    ...
    if (codexToolFrameForceAfter5hEnabled.value) {
      extra.codex_tool_frame_force_after_5h = true
    } else {
