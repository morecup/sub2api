...
const emit = defineEmits(['close', 'test', 'stats', 'schedule', 'reauth', 'refresh-token', 'recover-state', 'reset-quota', 'set-privacy', 'codex-invite', 'codex-reset-credits', 'create-spark-shadow'])
const { t } = useI18n()
