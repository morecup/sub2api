export default {
    accounts: {
      ...
      resetQuota: '重置配额',
      codexInvite: '邀请好友',
      codexResetCredits: '重置额度',
      codexInviteEligible: '有资格邀请好友',
      codexInviteNotEligible: '无资格邀请好友',
      codexInviteEmails: '邮箱地址',
      codexInviteEmailsPlaceholder: '输入邮箱地址，每行一个或用逗号分隔',
      codexInviteEmailsHint: '支持多个邮箱，用换行或逗号分隔',
      codexCheckEligibility: '检查资格',
      codexSendInvite: '发送邀请',
      codexInviteSent: '邀请已发送',
      codexInviteFailed: '邀请失败',
      codexNoCredits: '暂无可用的重置额度',
      codexConsumeCredit: '消耗',
      codexCreditConsumed: '额度已消耗',
      codexConsumeFailed: '消耗额度失败',
      codexCreditsFailed: '获取额度失败',
      quotaLimit: '配额限制',
      ...
      openai: {
        ...
        codexTicketProxy: '打票出口',
        codexTicketProxyGlobal: '跟随全局打票代理',
        codexTicketProxyAccount: '使用账号业务出口（无代理时直连）',
        codexTicketProxyDesc: '默认跟随全局打票代理。也可使用账号业务出口或指定其他代理；仅影响门票采集请求。所选代理不可用时会暂停打票，不会改用其他 IP。',
      ...
      weight: '权重',
      weightHint: '仅在同一优先级内生效；权重越大，账号获得的流量比例越高',
