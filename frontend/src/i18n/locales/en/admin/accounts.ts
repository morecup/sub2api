export default {
    accounts: {
      ...
      codexInvite: 'Invite Friends',
      codexResetCredits: 'Reset Credits',
      codexInviteEligible: 'Eligible to invite friends',
      codexInviteNotEligible: 'Not eligible to invite friends',
      codexInviteEmails: 'Email Addresses',
      codexInviteEmailsPlaceholder: 'Enter email addresses, one per line or comma-separated',
      codexInviteEmailsHint: 'Multiple emails supported, separated by newlines or commas',
      codexCheckEligibility: 'Check Eligibility',
      codexSendInvite: 'Send Invite',
      codexInviteSent: 'Invites sent successfully',
      codexInviteFailed: 'Failed to send invites',
      codexNoCredits: 'No reset credits available',
      codexConsumeCredit: 'Consume',
      codexCreditConsumed: 'Credit consumed successfully',
      codexConsumeFailed: 'Failed to consume credit',
      codexCreditsFailed: 'Failed to fetch credits',
      ...
      openai: {
        ...
        codexTicketDisabled: 'Force ticket harvesting off for this account',
        codexTicketDisabledCreateDesc: 'New accounts default to no ticket harvesting, injection or missing-ticket blocking. Uncheck to follow global settings.',
        codexTicketProxy: 'Ticket harvest egress',
        codexTicketProxyGlobal: 'Use global harvest proxy',
        codexTicketProxyAccount: 'Use account egress (direct if none)',
        codexTicketProxyDesc: 'Uses the global harvest proxy by default. You may use the account egress or another proxy. This affects harvesting only; if the selected proxy is unavailable, harvesting pauses without switching IPs.',
        codexTicketDisabledDesc: 'After saving, this account neither harvests nor injects tickets and is not blocked for missing tickets, even when globally enabled. Uncheck to follow global settings. Accounts with scheduling disabled still do not harvest tickets.',
      ...
      weight: 'Weight',
      weightHint: 'Applies only within the same priority; higher weights receive more traffic',
