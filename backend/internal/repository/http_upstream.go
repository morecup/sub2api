...
const (
	...
	// client version. The version identity itself lives in the xai package
	// (xai.CLIClientVersion / xai.EffectiveCLIClientVersion) so chat
	// forwarding, billing probes and OAuth token traffic share one source.
