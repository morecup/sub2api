...
func (cs *clientStream) encodeAndWriteHeaders(req *http.Request) error {
	...
	res, err := encodeRequestHeaders(req, cs.requestedGzip, cc.peerMaxHeaderListSize, cc.t.HeaderOrder, func(name, value string) {
...
func encodeRequestHeaders(req *http.Request, addGzipHeader bool, peerMaxHeaderListSize uint64, headerOrder *HeaderOrder, headerf func(name, value string)) (httpcommon.EncodeHeadersResult, error) {
