...
func sameAccountRetryDelayFor(failoverErr *service.UpstreamFailoverError, retryCounts ...int) time.Duration {
...
func effectiveSameAccountRetryLimit(failoverErr *service.UpstreamFailoverError, account *service.Account) int {
	if failoverErr != nil && failoverErr.SameAccountRetryLimitOverride > 0 {
		return failoverErr.SameAccountRetryLimitOverride
	}
	if account == nil {
		return 0
	}
