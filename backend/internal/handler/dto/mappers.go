...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		StandbyForAccountID:        a.StandbyForAccountID,
		StandbyTriggerTypes:        append([]string{}, a.StandbyTriggerTypes...),
		StandbyRuntimeState:        string(a.StandbyRuntimeState),
		StandbyPrimaryName:         a.StandbyPrimaryName,
		StandbyMatchedTriggerTypes: append([]string{}, a.StandbyMatchedTriggerTypes...),
