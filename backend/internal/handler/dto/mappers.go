...
func ProxyWithAccountCountFromService(p *service.ProxyWithAccountCount) *ProxyWithAccountCount {
	...
	return &ProxyWithAccountCount{
		...
		TrafficRequests:      p.TrafficRequests,
		RequestTrafficBytes:  p.RequestTrafficBytes,
		ResponseTrafficBytes: p.ResponseTrafficBytes,
		TotalTrafficBytes:    p.TotalTrafficBytes,
		TrafficStartTime:     p.TrafficStartTime,
		TrafficEndTime:       p.TrafficEndTime,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		RequestTrafficBytes:   l.RequestTrafficBytes,
		ResponseTrafficBytes:  l.ResponseTrafficBytes,
		TotalTrafficBytes:     l.TotalTrafficBytes,
