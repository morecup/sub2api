...
func (d *grokRealtimeTestDialer) Dial(_ context.Context, wsURL string, headers http.Header, proxyURL string, _ *openAIWSTLSProfile, _ string) (openAIWSClientConn, int, http.Header, error) {
	d.lastURL = wsURL
