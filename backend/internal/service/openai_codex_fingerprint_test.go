...
func newTestConvergenceSetupAccount(id int64, extra map[string]any) *Account {
...
func TestGetCodexFingerprintMode(t *testing.T) {
	tests := []struct {
		...
		{"无 extra 默认 off", newTestConvergenceSetupAccount(1, nil), codexFingerprintOff},
		{"空值默认 off", newTestConvergenceSetupAccount(1, map[string]any{codexFingerprintModeExtraKey: ""}), codexFingerprintOff},
		{"非法值默认 off", newTestConvergenceSetupAccount(1, map[string]any{codexFingerprintModeExtraKey: "invalid"}), codexFingerprintOff},
		{"显式 off", newTestConvergenceSetupAccount(1, map[string]any{codexFingerprintModeExtraKey: "off"}), codexFingerprintOff},
		{"device", newTestConvergenceSetupAccount(1, map[string]any{codexFingerprintModeExtraKey: "device"}), codexFingerprintDevice},
		{"session", newTestConvergenceSetupAccount(1, map[string]any{codexFingerprintModeExtraKey: "session"}), codexFingerprintSession},
		{"full", newTestConvergenceSetupAccount(1, map[string]any{codexFingerprintModeExtraKey: "full"}), codexFingerprintFull},
	}
...
func TestResolveConvergedInstallationID_UsesDeviceID(t *testing.T) {
	account := newTestConvergenceSetupAccount(1, map[string]any{"openai_device_id": "real-device-id"})
...
func TestResolveConvergedInstallationID_DerivesFromSeed(t *testing.T) {
	account := newTestConvergenceSetupAccount(42, nil)
...
func TestResolveConvergedInstallationID_DifferentSeeds(t *testing.T) {
	account := newTestConvergenceSetupAccount(1, nil)
...
func TestResolveCodexFingerprintIDsFromRequest_ExplicitOff(t *testing.T) {
	account := newTestConvergenceSetupAccount(1, map[string]any{codexFingerprintModeExtraKey: "off"})
...
func TestResolveCodexFingerprintIDsFromRequest_ExplicitOptInHonored(t *testing.T) {
	for _, mode := range []string{"device", "session", "full"} {
		t.Run(mode, func(t *testing.T) {
			account := newTestConvergenceSetupAccount(1, map[string]any{codexFingerprintModeExtraKey: mode})
			ids := resolveCodexFingerprintIDsFromRequest(account, nil)
...
func TestApplyCodexFingerprintHeaders_DeviceMode(t *testing.T) {
	account := newTestConvergenceSetupAccount(1, map[string]any{
...
func TestFingerprintIDs_MalformedEmbeddedMetadataRebuiltConsistently(t *testing.T) {
	account := newTestConvergenceSetupAccount(2, map[string]any{codexFingerprintModeExtraKey: "session"})
...
func TestApplyCodexFingerprintPromptCacheKey_MapRawEquivalence(t *testing.T) {
	for _, mode := range []codexFingerprintMode{codexFingerprintSession, codexFingerprintFull} {
		t.Run(string(mode)+"/default", func(t *testing.T) {
			account := newTestConvergenceSetupAccount(4300, map[string]any{codexFingerprintModeExtraKey: string(mode)})
	...
	t.Run("explicit override", func(t *testing.T) {
		account := newTestConvergenceSetupAccount(4301, map[string]any{codexFingerprintModeExtraKey: "session"})
...
func TestApplyCodexFingerprintPromptCacheKey_Negatives(t *testing.T) {
	sessionAccount := newTestConvergenceSetupAccount(4310, map[string]any{codexFingerprintModeExtraKey: "session"})
	sessionIDs := resolveCodexFingerprintIDs(sessionAccount, "header-session", codexFingerprintSession)
	require.NotNil(t, sessionIDs)
	deviceAccount := newTestConvergenceSetupAccount(4311, map[string]any{codexFingerprintModeExtraKey: "device"})
...
func TestApplyCodexFingerprintClientMetadataRaw_MatchesMapVariant(t *testing.T) {
	...
	for _, mode := range []codexFingerprintMode{codexFingerprintDevice, codexFingerprintSession, codexFingerprintFull} {
		account := newTestConvergenceSetupAccount(4242, map[string]any{codexFingerprintModeExtraKey: string(mode)})
...
func TestApplyCodexFingerprintClientMetadataRaw_PreservesUnrelatedFields(t *testing.T) {
	account := newTestConvergenceSetupAccount(4243, map[string]any{codexFingerprintModeExtraKey: "session"})
...
func TestStageCodexFingerprintIDs_NilOverwritesPreviousAccount(t *testing.T) {
	...
	accountA := newTestConvergenceSetupAccount(1001, map[string]any{codexFingerprintModeExtraKey: "session"})
	...
	accountB := newTestConvergenceSetupAccount(1002, map[string]any{"codex_fingerprint_mode": "off"})
...
func TestApplyStagedCodexFingerprintRejectsDifferentOAuthAccount(t *testing.T) {
	c := newFingerprintStageTestContext(t)
	accountA := newTestConvergenceSetupAccount(1003, map[string]any{codexFingerprintModeExtraKey: "session"})
	idsA := resolveCodexFingerprintIDs(accountA, "sess-a", codexFingerprintSession)
	require.NotNil(t, idsA)
	stageCodexFingerprintIDs(c, idsA)

	accountB := newTestConvergenceSetupAccount(1004, map[string]any{codexFingerprintModeExtraKey: "session"})
	h := make(http.Header)
...
func TestApplyStagedCodexFingerprintHeaders_SkipsNonOAuthAccount(t *testing.T) {
	c := newFingerprintStageTestContext(t)
	oauthIDs := resolveCodexFingerprintIDs(newTestConvergenceSetupAccount(1003, map[string]any{codexFingerprintModeExtraKey: "session"}), "sess-y", codexFingerprintSession)
...
func TestBuildUpstreamRequestOpenAIPassthrough_AppliesStagedFingerprint(t *testing.T) {
	...
	account := newTestConvergenceSetupAccount(2001, map[string]any{
...
func TestBuildUpstreamRequestOpenAIPassthrough_OffModeKeepsIsolatedSession(t *testing.T) {
	svc := &OpenAIGatewayService{}
	account := newTestConvergenceSetupAccount(2002, map[string]any{
		"openai_oauth_passthrough": true,
...
func TestApplyCodexFingerprintClientMetadataRaw_NonObjectBodyUntouched(t *testing.T) {
	account := newTestConvergenceSetupAccount(4244, map[string]any{codexFingerprintModeExtraKey: "session"})
