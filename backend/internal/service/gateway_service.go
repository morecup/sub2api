...
type UpstreamFailoverError struct {
	...
	SameAccountRetryLimitOverride    int
	ImmediateSameAccountRetry        bool
	SkipRetryExhaustedTempUnschedule bool
	SuppressAccountScheduleFailure   bool
}
...
func (e *UpstreamFailoverError) ShouldReportAccountScheduleFailure() bool {
	...
	if e.SuppressAccountScheduleFailure {
		return false
	}
