...
const (
	...
	HTTPUpstreamProfileGrokControlPlane HTTPUpstreamProfile = "grok_control_plane"
)
...
func HTTPUpstreamProfileFromContext(ctx context.Context) HTTPUpstreamProfile {
	...
	switch profile {
	case HTTPUpstreamProfileGrokControlPlane, HTTPUpstreamProfileOpenAI, HTTPUpstreamProfileOpenAIHarvest, HTTPUpstreamProfileGrok, HTTPUpstreamProfileLongStream:
		return profile
	default:
		return HTTPUpstreamProfileDefault
	}
