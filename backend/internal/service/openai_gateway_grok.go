...
func (s *OpenAIGatewayService) forwardGrokResponses(
	...
	// Normalize service_tier (fast->priority, drop unknown) so upstream and billing share one value.
	...
	// Capture for billing after all upstream body normalization.
...
func buildGrokResponsesRequest(ctx context.Context, c *gin.Context, account *Account, body []byte, token, cacheIdentity string, cfg *config.Config, settings ...*SettingService) (*http.Request, error) {
	return buildGrokResponsesRequestWithTurnStore(ctx, c, account, body, token, cacheIdentity, cfg, nil, settings...)
}
...
func (s *OpenAIGatewayService) buildGrokResponsesRequest(ctx context.Context, c *gin.Context, account *Account, body []byte, token, cacheIdentity string, cfg *config.Config, settings ...*SettingService) (*http.Request, error) {
	...
	return buildGrokResponsesRequestWithState(ctx, c, account, body, token, cacheIdentity, cfg, turnStore, catalog, settings...)
}
...
func buildGrokResponsesRequestWithTurnStore(
	...
	return buildGrokResponsesRequestWithState(ctx, c, account, body, token, cacheIdentity, cfg, turnStore, nil, settings...)
}
