...
var duplicateAccountDiscardedExtraKeys = map[string]struct{}{
	...
	"codex_7d_reset_at":                        {},
	Codex7dFirstExhaustedAtExtraKey:            {},
	Codex7dFirstExhaustedWindowResetAtExtraKey: {},
...
func (s *adminServiceImpl) BulkUpdateAccounts(ctx context.Context, input *BulkUpdateAccountsInput) (*BulkUpdateAccountsResult, error) {
	...
	if len(input.Credentials) > 0 || input.ProxyID != nil || needMixedChannelCheck || openAISettings.any() || hasOpenAI429NoCooldownUpdate || input.ProbeEnabled != nil || input.RateMultiplier != nil {
