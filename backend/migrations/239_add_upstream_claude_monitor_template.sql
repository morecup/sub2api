-- Restore the upstream optional monitor template without rewriting migration 129.
-- Existing deployed migration checksums and user-edited templates remain valid.
-- Migration: 239_add_upstream_claude_monitor_template
